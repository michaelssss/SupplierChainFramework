...
import com.michaelssss.business.basicinfomanagement.service.ClassificationService;
...
public class ClassificationController {
  ...
  public Response<List<ProductionClassification>> list() {
    return (Response<List<ProductionClassification>>)
        Response.OK(classificationService.getLevelOneProductionClassification());
  }

  @RequestMapping(value = "SubClassification/add")
  @ApiOperation(value = "添加子分类", tags = "分类管理")
  @ResponseBody
  public Response<String> addSubClassification(
      @RequestBody ProductionClassificationDataBinder productionClassification) {
    ProductionClassification parent =
        classificationService.getById(productionClassification.getParentId());
    ...
    productionClassification1.setTemplateProperties(
        productionClassification.getTemplateProperties());
