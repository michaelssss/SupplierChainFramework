...
import com.michaelssss.rzzl2.accountingmanagement.PurchaseInvoice;
import com.michaelssss.rzzl2.accountingmanagement.PurchaseInvoiceCatalog;
...
public class PaymentVoucherController {
    ...
    public Response addTransferReceipt(@RequestBody Map<String, TransferReceipt> map) {
        PurchaseInvoice paymentVoucher = repository.findOne(Long.valueOf(map.get("id").toString()));
    ...
    public Response getAuditTotal(@RequestParam(value = "id") Long id) {
        PurchaseInvoice paymentVoucher = repository.findOne(id);
