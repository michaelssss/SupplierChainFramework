...
class OrderQueryImpl implements OrderQuery {
    ...
    @Autowired
    public OrderQueryImpl(EntrustedOrderRepository entrustedOrderRepository, PurchaseOrderRepository purchaseOrderRepository, SalesOrderRepository salesOrderRepository) {
