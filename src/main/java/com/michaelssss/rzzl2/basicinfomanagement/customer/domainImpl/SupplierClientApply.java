...
public class SupplierClientApply {
    ...
    public void addInfo() {
        SpringContextHolder.getBean(SupplierClientApplyRepository.class).saveAndFlush(this);
    ...
    public void deleteInfo(Long id) {
        SpringContextHolder.getBean(SupplierClientApplyRepository.class).delete(id);
