...
public class PurchaseClientApplyImpl {
    @Id
    ...
    public void addInfo() {
        SpringContextHolder.getBean(PurchaseClientApplyRepository.class).saveAndFlush(this);
    ...
    public void deleteInfo(Long id) {
        SpringContextHolder.getBean(PurchaseClientApplyRepository.class).delete(id);
