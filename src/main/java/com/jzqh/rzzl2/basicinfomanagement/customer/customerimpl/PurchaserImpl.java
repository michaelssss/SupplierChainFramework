...
import com.jzqh.rzzl2.basicinfomanagement.customer.Purchaser;
...
public class PurchaserImpl implements Purchaser {
    ...
    private Set<EntryApplyPurchaseImpl> entryApplyPurchaseSet;
    ...
    @Override
    public void addPermitInfo(EntryApplyPurchaseImpl entryApplyPurchase) {
